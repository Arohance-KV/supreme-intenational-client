...
const imageHostnames = (process.env.NEXT_PUBLIC_IMAGE_HOSTNAMES ?? "cdn.sovarest.com,pub-181901bfac0342f0b9a4d3476d6c8df0.r2.dev,pub-0c87a18c08294f9584a947eb07c508ff.r2.dev,loremflickr.com")
  .split(",")
  .map((h) => h.trim())
  .filter(Boolean);

# Graph Report - client  (2026-08-13)

## Corpus Check
- 249 files · ~152,854 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1600 nodes · 3201 edges · 88 communities (81 shown, 7 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 141 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ca2113e2`
...
- `VariantRow()` --calls--> `useConfirm()`  [INFERRED]
  app/admin/catalog/products/[id]/page.tsx → components/ConfirmDialog.tsx
- `AddVariantForm()` --calls--> `useAttributes()`  [INFERRED]
  app/admin/catalog/products/[id]/page.tsx → lib/admin/taxonomy.ts
- `ProductsTable()` --calls--> `useAdminProducts()`  [INFERRED]
  app/admin/catalog/products/page.tsx → lib/admin/products.ts
...
Cohesion: 0.18
Nodes (8): AdminSeller, SellerStatus, useUpdateSeller(), STATUS_CLASS_MAP, StatusChip(), StatusChipProps, SellerEditForm(), MarginEditor()

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (46): ImportResult, AddVariantForm(), ProductRow(), ProductDetailPage(), SubmissionDetailPage(), NewSubmissionPage(), SellerProductsPage(), Paginated (+38 more)
...
Cohesion: 0.10
Nodes (28): AdminProduct, AdminProductDetail, AdminProductDetailResponse, AdminProductsResponse, BulkCreateVariantsBody, CreateVariantBody, FlashSaleBody, PRODUCT_DETAIL_KEY() (+20 more)
...
Cohesion: 0.05
Nodes (54): BulkImportWizard(), AdminSubmission, ATTR_REVIEW_KEY(), AttributeReview, AttributeReviewItem, DraftVariant, DraftVariantAttribute, RejectSubmissionBody (+46 more)
...
Cohesion: 0.09
Nodes (23): AdminEmployee, COMPANY_CATALOG_KEY(), COMPANY_LOGINS_KEY(), CreateCompanyLoginBody, InviteEmployeeBody, LedgerEntry, UpdateCompanyBody, useBulkAllocateSelected() (+15 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (51): AdminBlog, AdminBlogsResponse, BLOG_DETAIL_KEY(), BLOGS_LIST_KEY(), CreateBlogBody, UpdateBlogBody, useBlog(), useBlogs() (+43 more)

### Community 18 - "Community 18"
Cohesion: 0.11
Nodes (23): SELLER_KEY(), SELLER_PERFORMANCE_KEY(), SELLER_PRODUCTS_KEY(), SellerContact, SellerPerformance, SellerProduct, SellerProductsResponse, SELLERS_LIST_KEY() (+15 more)

### Community 19 - "Community 19"
Cohesion: 0.21
Nodes (10): adminUpload(), importProductsCsv(), CompanyProfile, PROFILE_KEY, T, uploadCompanyLogo(), generateId(), getSessionId() (+2 more)
...
Cohesion: 0.38
Nodes (3): _nav, mockApiFetch, ApiError
...
Cohesion: 0.13
Nodes (13): HIDE, Popup, QuotationHistoryPage(), apiFetch(), ApiFetchOptions, emailQuotation(), GenerateQuotationBody, getQuotationPdfUrl() (+5 more)
...
Cohesion: 0.13
Nodes (15): TABS, CompanyOrdersFilter, CompanyOrderSummary, exportCompanyOrdersCsv(), OrdersPage, OrdersPagination, OrderStatus, T (+7 more)
...
Cohesion: 0.15
Nodes (20): CartPage(), CartItemRow(), CartItemRowProps, formatPrice(), CartView(), CartViewProps, formatPrice(), B2B_LOCK_CODES (+12 more)
...
Cohesion: 0.18
Nodes (9): listeners, useCookieAuth(), useSellerAuth(), useSellerMe(), PUBLIC, SellerGuard(), NAV, PUBLIC (+1 more)
...
Cohesion: 0.12
Nodes (16): geistMono, geistSans, jakarta, jbMono, metadata, Providers(), activeKey(), ConditionalSiteHeader() (+8 more)

### Community 45 - "Community 45"
Cohesion: 0.15
Nodes (13): CartBadge(), CartBadgeProps, useEmployeeAuth(), useEmployeeCompany(), useRecentlyViewed(), EmployeeFooter(), EmployeeHeader(), EmployeeTabBar() (+5 more)
...
Cohesion: 0.19
Nodes (14): COMPANIES_LIST_KEY(), useCompanies(), CreateProductModal(), CreateProductBody, useAdminProductsInfinite(), useCreateProduct(), useDeleteProduct(), useImportProducts() (+6 more)

### Community 51 - "Community 51"
Cohesion: 0.26
Nodes (10): COMPANY_KEY(), useCompany(), AdminPointsProposal, DecideProposalBody, PROPOSALS_KEY, useDecideProposal(), usePendingProposals(), CompanyDetailInner() (+2 more)
...
Cohesion: 0.11
Nodes (13): advantages, advTags, directors, jakarta, metadata, mono, stats, DcNav() (+5 more)

### Community 56 - "Community 56"
Cohesion: 0.32
Nodes (5): useQuotationAnalytics(), useQuotations(), AnalyticsCards(), QUOTATION_STATUSES, QuotationsTable()
...
Cohesion: 0.38
Nodes (7): formatDate(), formatIN(), formatLakh(), initials(), parsePointsInput(), useCompanyOrder(), CompanyOrderDetailPage()
...
Cohesion: 0.26
Nodes (8): AddToCartMini(), CartTarget, EMPLOYEE_CART, PUBLIC_CART, ProductCardProps, SupremeSection(), Product, ProductDetail
...
Cohesion: 0.28
Nodes (6): SellerDashboard, T, useSellerDashboard(), SellerDashboardPage(), STATUS_CHIP, STATUS_LABEL
...
Cohesion: 0.67
Nodes (3): SellerLoginPage(), STATUS_MSG, useSellerLogin()
...
Cohesion: 0.33
Nodes (7): QuotationStatus, useApproveQuotation(), useQuotation(), useUpdateQuotationStatus(), fmtDateTime(), AdminQuotationDetailPage(), QUOTATION_STATUSES
...
## Knowledge Gaps
- **479 isolated node(s):** `jakarta`, `mono`, `metadata`, `stats`, `directors` (+474 more)
...
- **Why does `ApiError` connect `Community 21` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 11`, `Community 12`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 23`, `Community 24`, `Community 25`, `Community 32`, `Community 37`, `Community 38`, `Community 39`, `Community 40`, `Community 46`, `Community 47`, `Community 50`, `Community 51`, `Community 52`, `Community 53`, `Community 58`, `Community 60`, `Community 62`, `Community 63`, `Community 64`, `Community 69`, `Community 74`, `Community 77`, `Community 79`?**
  _High betweenness centrality (0.127) - this node is a cross-community bridge._
- **Why does `apiFetch()` connect `Community 25` to `Community 3`, `Community 5`, `Community 7`, `Community 8`, `Community 11`, `Community 14`, `Community 15`, `Community 19`, `Community 21`, `Community 23`, `Community 24`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 36`, `Community 37`, `Community 38`, `Community 39`, `Community 40`, `Community 42`, `Community 49`, `Community 52`, `Community 53`, `Community 58`, `Community 64`, `Community 71`, `Community 75`, `Community 76`, `Community 87`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `adminFetch()` connect `Community 62` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 6`, `Community 7`, `Community 12`, `Community 60`, `Community 17`, `Community 18`, `Community 51`, `Community 21`, `Community 54`, `Community 27`, `Community 28`?**

    ...
    <main className="max-w-3xl mx-auto px-4 py-10">
      ...
      {result && (
        <section className="bg-green-50 border border-green-200 rounded-xl p-6 mb-6 space-y-4">
          <h2 className="text-lg font-semibold text-green-800">Quotation Submitted!</h2>
          <p className="text-sm text-green-700">
            Quotation ID: <span className="font-mono font-semibold">{result.quotationId}</span>
          </p>
          <p className="text-sm text-green-700">
            Your quotation is pending approval. You&apos;ll be able to download the PDF and share it
